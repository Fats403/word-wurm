  ...
  return (
    ...
    >
      <div className="w-1/2 h-full border-r-2 border-gray-400 flex items-center justify-center flex-col">
        <span className="font-bold text-sm">Longest Word</span>
        <span className="text-xs">{longestWord.toUpperCase() || "-"}</span>
      </div>
      <div className="w-1/2 h-full flex items-center justify-center flex-col">
        <span className="font-bold text-sm">Bonus Word</span>
        <span className="text-xs">{bonusWord.toUpperCase() || "-"}</span>
      </div>
    </div>
  );
};
